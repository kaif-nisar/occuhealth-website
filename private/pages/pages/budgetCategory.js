...
async function loadCategories() {
    try {
        showLoading();
        const response = await fetch(`${BASE_URL}/api/v1/user/getAllCategories-tenant`, {
            method: 'GET',
            headers: getHeaders()
        });
...
async function loadStats() {
    try {
        const response = await fetch(`${BASE_URL}/api/v1/user/getCategoryStats-tenant`, {
            method: 'GET',
            headers: getHeaders()
        });
...
async function handleSearch() {
    ...
    try {
        showLoading();
        const response = await fetch(`${BASE_URL}/api/v1/user/searchCategories-tenant?query=${encodeURIComponent(query)}`, {
            method: 'GET',
            headers: getHeaders()
        });
...
async function editCategory(id) {
    try {
        const response = await fetch(`${BASE_URL}/api/v1/user/getCategoryById-tenant/${id}`, {
            method: 'GET',
            headers: getHeaders()
        });
...
async function saveCategory() {
    ...
    try {
        ...
        const url = currentEditId 
            ? `${BASE_URL}/api/v1/user/updateCategory-tenant/${currentEditId}`
            : `${BASE_URL}/api/v1/user/addNewCategory-tenant`;
...
async function deleteCategory(id) {
    ...
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/v1/user/deleteCategory-tenant/${id}`, {
            method: 'DELETE',
            headers: getHeaders()
        });
