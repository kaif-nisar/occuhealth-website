...
(async function () {
    ...
    async function fetchdoctorsandlabsign() {
        try {
            ...
            div.innerHTML = `            
            <div class="left-sign" style="display: ${reportformatfirstdoctorsign ? 'block' : 'none'};">
                <img src="${doctorsdata.firstdoctorsign || ""}" width="95" height="35" /><br>
                <div class="textspan">${doctorsdata.firstdoctorsigninfo}</div>
            </div>
            <div class="left-sign" style="display: ${reportformatlabsign ? 'block' : 'none'};">
                <img src="${doctorsdata.labinchargesign || ""}" width="95" height="35" /><br>
            ...
            <div class="right-sign" style="display: ${reportformatseconddoctorsign ? 'block' : 'none'};">
                <img src="${doctorsdata.seconddoctorsign || ""}" width="95" height="35" /><br>
    ...
    async function sendReport() {
        ...
        openPdfButton.addEventListener('click', () => {
            ...
            // Patient name + date se PDF download trigger karo
            ...
            // New tab mein patient name title ke saath PDF kholo
    ...
    async function populateHeader() {
        ...
        patientdetails.innerHTML = `<div class="format1left2">
                <div class="format1-infor-div fixedheightdiv"><div class="format1-tags">Patient Name:</div><div class="value">${report.patientName}</div></div>
            ...
            <div class="sign click qr-div">
                ...
                <div class="branding">
                    ...
                    <span class="occusoft">www.OccuHealth.in</span>   
                </div>
            </div>
            `;
    ...
    async function barcodegenerator() {
        ...
        if (!barcodeNumber) {
            console.warn("Barcode source not available for reportFormat1");
            return;
        }
    ...
    async function downloadpdffunction({ labinchargesign = null, checkBox = false, labinchargeinfo = "",
        ...
        document.getElementById('downloadPDF').addEventListener('click', async (e) => {
            ...
            try {
                ...
                // Patient name + date se named PDF download karo
