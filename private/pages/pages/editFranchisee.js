function editFranchi() {
        ...
        if (_id) {
            fetch(`${BASE_URL}/api/v1/user/superFranchisee-fetch?_id=${_id}`)
                ...
                .then(data => {
                    ...
                    // Set overdraft permission checkbox
                    if (document.getElementById('canManageOverdraft')) {
                        document.getElementById('canManageOverdraft').checked = data.canManageOverdraft || false;
                    }
                })
    ...
    async function updateFranchisee() {
        ...
        const data = {
            ...
            canManageOverdraft: document.getElementById('canManageOverdraft')?.checked || false
        };
        try {
