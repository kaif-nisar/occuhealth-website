...
document.getElementById('searchBtn').addEventListener('click', () => {
    ...
    if (selectedFranchiseeId) {
        ...
        if (userRole === "franchisee") {
            redirectPage = "franchisee/franchisee.html?page=rate_list_copy";
        } else if (userRole === "subFranchisee") {
            redirectPage = "subFranchisee/subFranchisee.html?page=rate_list_copy";
        } else if (userRole === "admin" || userRole === "staff") {
            redirectPage = "admin/admin.html?page=rate_list";
        } else if (userRole === "superFranchisee") {
            redirectPage = "superFranchisee/superFranchisee.html?page=rate_list_copy";
        }
