(function(){
  ...
  async function checkPermission(){
    try {
      const res = await fetch(apiBase + '/get-current-user', { credentials: 'include' });
  ...
  async function fetchFranchisees(){
    try{
      ...
      const res = await fetch(apiBase + '/get-my-franchisees', { credentials: 'include' });
  ...
  saveBtn.addEventListener('click', async ()=>{
    ...
    try{
      const res = await fetch(apiBase + '/set-overdraft', {
        method: 'POST',
        credentials: 'include',
