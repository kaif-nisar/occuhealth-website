        ...
        // ============= FIXED: Fetch Pending Bookings with Loader =============
            ...
            try {
                ...
                bookings.forEach((booking, index) => {
                    ...
                    switch (booking.status.toLowerCase()) {
                        case 'on hold':
                            statusColor = 'red';
                            rowBgColor = 'rgba(255, 0, 0, 0.1)';
                            break;
                        case 'pending':
                            statusColor = 'orange';
                            rowBgColor = 'rgba(255, 165, 0, 0.1)';
                            break;
                        case 'completed':
                            statusColor = 'green';
                            rowBgColor = 'rgba(0, 255, 0, 0.1)';
                            break;
                        default:
                            statusColor = 'black';
                ...
                tableBody.innerHTML = `
                    <tr>
                        <td colspan="7" style="padding: 20px; text-align: center; color: #dc3545;">
                            ...
                            Failed to load pending bookings. Please check your connection.
                        </td>
                    </tr>
                `;
                allRows = [];
